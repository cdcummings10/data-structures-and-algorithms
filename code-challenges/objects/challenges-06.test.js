...
const hasChildrenEntries = (arr, character) => {
  ...
  let answer = false;
  arr.forEach(element => {
    console.log(Object.entries(element)[0][1] === character && !!Object.entries(element)[2][1][0])
    if (Object.entries(element)[0][1] === character && !!Object.entries(element)[2][1][0]){
      answer = true;
    }
  });
  return answer;
